...
``` {=html}
{{< include ../includes/roesterei-positionierung.html >}}
```

::: {.notes}
Die Achsen sind die Dimensionen, nach denen die Zielgruppe der Rösterei Morgenrot entscheidet: Preis und Kaufart. Günstige Einzelkäufe decken Supermarkt und Großversender ab, teure Spezialitäten eine Spezialitätenrösterei, das teure Abo ein Kapselanbieter. [KLICK] Frei ist frischer Kaffee im Abo zum mittleren Preis. Der Platz lohnt sich nur, wenn dort genügend Menschen sitzen, hier die Homeoffice-Haushalte, und das eigene Angebot ihn halten kann, hier mit Röstdatum und festem Lieferrhythmus. Alle Anbieter sind erfunden.
:::
